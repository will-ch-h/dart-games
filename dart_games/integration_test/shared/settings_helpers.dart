...
class SettingsHelpers {
  ...
  /// Set to true after an epoch-bumping call completes successfully.
  ...
  ///
  /// Generates a monotonically-increasing token and passes it to the
  ...
  /// Used by navigateToGameMenu / navigateToHomeScreen for their
  /// mid-navigation and post-navigation resets.
  ...
  static Future<void> _initializeSettingsImpl({
    ...
    // cleanup-only calls (navigateToGameMenu, navigateToHomeScreen)
    // never bump the epoch.  This avoids relying on a boolean parameter
    // that DDC may not compile correctly.
