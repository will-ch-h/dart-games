...
if "!run_all!"=="1" (
    ...
    echo Running Filtered UI Automation Tests: !filter!
)
echo ========================================
echo.
...
start /B "" cmd /C "flutter drive --driver=test_driver/!_RST_DRIVER! --target=!_RST_TARGET! -d chrome >> "!_RST_LOG!" 2>&1"
...
for %%G in (%GAMES%) do (
    ...
    REM Check if this game matches the filter (if filtering)
    set "_game_matches=0"
    ...
    if "!_game_matches!"=="1" (
        ...
        if exist "ui_test_data" move "ui_test_data" "integration_test_output\test_data_%%G" >nul 2>&1
        call :start_services
        ...
        for %%F in ("!_GAME_DIR!\*_test.dart") do (
            ...
            REM Check filter for specific file matching
            set "_file_matches=0"
            ...
            if "!_file_matches!"=="1" (
                REM Determine driver: screenshot tests use screenshot_test.dart
        ...
        for /d %%D in ("!_GAME_DIR!\*") do (
            ...
            REM Check filter for subdirectory matching
            ...
            REM Also match if game already matched
            ...
            if "!_subdir_matches!"=="1" (
                for %%F in ("%%D\*_test.dart") do (
                    ...
                    REM Also match if subdirectory matched
        ...
        echo.
        echo Restarting services for next game...
        call :kill_services
    )
)
